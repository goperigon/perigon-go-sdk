...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Companies.List(context.Background(), perigon.CompanyListParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Companies.List(context.Background(), perigon.CompanyListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Companies.List(cancelCtx, perigon.CompanyListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Companies.List(deadlineCtx, perigon.CompanyListParams{})
		if err == nil {
