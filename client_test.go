...
func TestUserAgentHeader(t *testing.T) {
	...
	client.All.List(context.Background(), perigonsdk.AllListParams{})
	if userAgent != fmt.Sprintf("PerigonSDK/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.All.List(context.Background(), perigonsdk.AllListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.All.List(cancelCtx, perigonsdk.AllListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.All.List(deadlineCtx, perigonsdk.AllListParams{})
		if err == nil {
