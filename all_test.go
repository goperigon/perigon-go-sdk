...
func TestAllListWithOptionalParams(t *testing.T) {
	...
	_, err := client.All.List(context.TODO(), perigon.AllListParams{
		...
		ExcludeCompanyIsin:       []string{"string"},
		ExcludeCompanySymbol:     []string{"string"},
		ExcludeCompanySymbolIsin: []string{"string"},
		...
		ExcludeSourceCity:        []string{"string"},
		ExcludeSourceCountry:     []string{"string"},
		ExcludeSourceCounty:      []string{"string"},
		ExcludeSourceGroup:       []string{"string"},
		ExcludeSourceState:       []string{"string"},
		...
		HighlightPreTag:          perigon.String("highlightPreTag"),
		HighlightQ:               perigon.String("highlightQ"),
